...
public class EmployeeRepositoryPerformanceTest extends AbstractBenchmark {
    ...
    public void addTest() {
        ...
        employee = template.postForObject("http://localhost:8082/employees", employee, Employee.class);
    ...
    public void findByNameTest() {
        ...
        Employee[] employees = template.getForObject("http://localhost:8082/employees/{name}", Employee[].class, name);
    ...
    public void findByOrganizationNameTest() {
        ...
        Employee[] employees = template.getForObject("http://localhost:8082/employees/organization/{organizationName}", Employee[].class, organizationName);
        LOGGER.info("Found: {}", employees.length);
        Assert.assertNotNull(employees);
    }
